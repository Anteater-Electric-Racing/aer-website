    ...
    <footer className="bg-vintage-navy text-white border-t border-vintage-orange/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-lg font-bold text-vintage-yellow uppercase tracking-widest mb-6">
              Explore
            </h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/about"
                  className="text-gray-300 hover:text-vintage-orange transition-colors"
                >
                  About Us
                </Link>
              </li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-sm text-gray-400">
          <p>
            &copy; {currentYear} Anteater Electric Racing. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

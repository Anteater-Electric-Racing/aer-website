    ...
    <main className="flex flex-col min-h-screen bg-vintage-white">
      ...
      <section className="py-20 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <h2 className="text-3xl font-bold text-vintage-navy uppercase tracking-wider">
            Our Mission
          </h2>
            ...
            {[
              {
                icon: Zap,
                name: "Innovation",
                desc: "Pushing boundaries of EV tech",
              },
              {
                icon: Users,
                name: "Teamwork",
                desc: "Collaborating across disciplines",
              },
              {
                icon: Lightbulb,
                name: "Creativity",
                desc: "Finding unique solutions",
              },
              {
                icon: Trophy,
                name: "Excellence",
                desc: "Striving for highest standards",
              },
            ].map((val) => (
              <div
                key={val.name}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-vintage-navy mb-2">
                  {val.name}
                </h3>
          ...
          {[
            {
              ...
              desc: "State-of-the-art motor control",
            },
            {
              icon: Cog,
              name: "CAD/CAM",
              desc: "Precision design & manufacturing",
            },
            {
              icon: Battery,
              name: "Battery Tech",
              desc: "High-performance Li-ion systems",
            },
            {
              icon: Shield,
              name: "Safety Systems",
              desc: "Data acquisition & driver safety",
            },
          ].map((tech) => (
            <div
              key={tech.name}
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-bold text-vintage-navy">
                  {tech.name}
                </h3>
